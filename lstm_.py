...
def zeros_like(L):
    return [np.zeros(l.shape) for l in anL backward(layers_params,
             forward_result,
             d_X_next_layer):
...
if __name__ == "__main__":
    ...
    learning_rate = 1e-2
    def gradient_check(updates, layers, W, b, X, y, subsample=False, epsilon=1e-4):
